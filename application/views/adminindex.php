...
<table class="menu">
<tr><td>
<a href="<?=site_aurl('adminindex')?>" class="current"><?=lang('func_adminindex')?></a>
</td></tr>
</table>
</div>
...
<tr><td width="15%"><?=lang('user_name')?></td><td width="35%"><?=$user['username']?></td><td width="15%"></td><td width="35%"></td></tr>
...
<!--
<tr><td width="15%"><?=lang('func_down')?></td><td width="35%"><?=$this->db->count_all('down')?></td><td width="50%"  style="padding:0;" colspan="2" rowspan="6"></td></tr>
