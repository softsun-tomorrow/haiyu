...
<?php elseif($tpl=='view'):?>
    ...
    <tr>
        <td><?=lang('category_isdisplay')?></td>
        <td><?=lang('yes')?><input type="radio" name="isdisplay" value="1" <?php if(isset($view['isdisplay'])&&$view['isdisplay']==1){echo 'checked';} ?>  /><?=lang('no')?><input type="radio" name="isdisplay" value="0" <?php if(!isset($view['isdisplay'])||$view['isdisplay']==0){echo 'checked';} ?> /></td>
	</tr>
	...
	<tr>
		...
		<td ><input type="text" name="pagesize" id="pagesize" size="5" class="input-text" value="<?=isset($view['pagesize'])?$view['pagesize']:'0';?>"></td>
