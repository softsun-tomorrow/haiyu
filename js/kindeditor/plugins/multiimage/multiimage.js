...
K.extend(KSWFUpload, {
	init : function(options) {
		...
		self.div = K(options.container).html([
			...
			'</div>',
			'<div class="ke-inline-block ke-swfupload-desc">'+options.iswater+'<input type="checkbox" name="iswater" id="iswater" value="1">&nbsp;&nbsp;' + options.uploadDesc + '</div>',
...
KindEditor.plugin('multiimage', function(K) {
	var self = this, name = 'multiimage',
		...
		imageFileTypes = K.undef(self.imageFileTypes, '*.gif;*.jpg;*.jpeg;*.png;*.bmp'),
	...
	self.plugin.multiImageDialog = function(options) {
		...
		var swfupload = K.swfupload({
			...
			iswater : lang.iswater,
			startButtonValue : lang.startUpload,
			uploadUrl : uploadJson+'?dir=image',
...
SWFUpload.prototype.returnUploadStart = function (file) {
	...
	if (typeof this.settings.upload_start_handler === "function") {
		...
		this.setPostParams({"iswater":iswater });
