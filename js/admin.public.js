...
function setProductAttributeClass(t){
    if( "SURF GEAR" == $("#category  option:selected").html()) {
...
function uploadattributepic(t,picid){
	var editor = KindEditor.editor({
		fileManagerJson:siteaurl+"/main/attrlist/attibute",
		uploadJson:siteaurl+"/main/attrupload/attibute",
		allowFileManager : true
	});
...
function uploadproductpic(t,picid){
	var editor = KindEditor.editor({
		fileManagerJson:siteaurl+"/main/attrlist/products",
		uploadJson:siteaurl+"/main/attrupload/products",
		allowFileManager : true
	});
	editor.loadPlugin('image', function() {
		editor.plugin.imageDialog({
