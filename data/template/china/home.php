...
<div class="container">
	...
	<div class="index-content ks-clear" style="padding:16px 20px;">
		<ul style="width:980px;overflow:hidden;">
			<?php $tmpLink = x6cms_link(6);?>
			<?php foreach($tmpLink as $key=>$item):?>
				
				<li style="margin-right:13.5px;" val="<?=$key?>" class="<?=$item['title']?>"><a href="<?=$item['url']?>"><img src="<?=(isset($config['base_url'])?$config['base_url']:'').$item['thumb'];?>" alt=""/><i class="i1 pngfix"></i><i class="i2 pngfix"></i></a></li>
