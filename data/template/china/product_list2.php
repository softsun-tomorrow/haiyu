  		...
  		<div class="left-nav gear-left">
        	<ul id="left_menu" >
				...
				<?php foreach($genderArrChild as $val):?>
					...
					?>
						<a data-id="<?=$val['id']?>" lev="1" href="javascript:void(0);" class="<?php if(in_array($val['id'],$where)){?> current <?php }?>"><?php echo $val['name'];?></a>
				...
				?>				
					<a data-id="<?=$val['id']?>" lev="2" href="javascript:void(0);" class="<?php if(in_array($val['id'],$where)){?> current <?php }?>"><?php echo $val['name'];?></a>
